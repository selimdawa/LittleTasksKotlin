...
class ProfileEditActivity : AppCompatActivity() {
    ...
    var ref = FirebaseDatabase.getInstance().getReference(DATA.USERS)
    var id = DATA.FirebaseUserUid
    ...
    private fun validateData() {
        ...
        if (TextUtils.isEmpty(username)) {
            ...
            if (imageUri == null) {
                updateProfile(DATA.EMPTY, id, ref)
            } else {
                uploadImage()
            }
        }
    ...
    private fun uploadImage() {
        ...
        reference.putFile(imageUri!!)
            .addOnSuccessListener { taskSnapshot: UploadTask.TaskSnapshot ->
                ...
                updateProfile(uploadedImageUrl, id, ref)
    ...
    private fun updateProfile(imageUrl: String?, id: String?, ref: DatabaseReference) {
